...
class Elementor_oEmbed_Widget extends \Elementor\Widget_Base {
	...
	public function get_title(): string {
		return esc_html__( 'Basic Style Widget', 'elementor-basic-widget' );
	}
	...
	public function get_keywords(): array {
		return [ 'Basic Widget', 'url', 'link','Style Widget' ];
	}
	...
	protected function register_controls(): void {
		...
		$this->start_controls_section(
			'content_section',
			[
				'label' => esc_html__( 'Content', 'elementor-basic-widget' ),
		...
		$this->add_control(
			'url',
			[
				'label' => esc_html__( 'URL', 'elementor-basic-widget' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'input_type' => 'url',
				'placeholder' => esc_html__( 'https://your-link.com', 'elementor-basic-widget' ),
			]
		);
			...
			[
				'type' => \Elementor\Controls_Manager::TEXT,
				'label' => esc_html__( 'Heading', 'elementor-basic-widget' ),
				'placeholder' => esc_html__( 'Enter Heading', 'elementor-basic-widget' ),
			]
		);
        ...
        $this->add_control(
			'description',
			[
				'label' => esc_html__( 'Description', 'elementor-basic-widget' ),
				'type' => \Elementor\Controls_Manager::TEXTAREA,
				'default' => esc_html__( 'Description', 'elementor-basic-widget' ),
			]
		);
